...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Assert.AreEqual failed. Expected:<Bob>. Actual:<Sue> i.e. enqueue is implemented wrongly.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Assert.AreEqual failed. Expected:<Tim>. Actual:<Sue> i.e. enque is implemented wrongly.
    ...
    // Defect(s) Found: Assert.AreEqual failed. Expected:<Tim>. Actual:<Sue> i.e. enqueue is implemented wrongly.
